                        ...
                        <div className="-my-6 divide-y divide-gray-500/10">
                            <div className="space-y-2 py-6">
                                <Disclosure as="div" className="-mx-3">
                                    <DisclosureButton className="group flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-sm font-semibold leading-7 text-white hover:bg-gray-50">
                                        Product
                                ...
                                <Link
                                    href="/"
                                    className="-mx-3 block rounded-lg px-3 py-2 text-sm font-semibold leading-7 text-white hover:bg-gray-50"
                                >
                                    Features
                                </Link>
                                <Link
                            ...
                            <div className="py-6">
                                <Link
                                    href="/"
                                    className="-mx-3 block rounded-lg px-3 py-2.5 text-sm font-semibold leading-7 text-white hover:bg-gray-50"
                                >
                                    Log in
                                </Link>
                            </div>
